...
model_name = "VGG_nexar2_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/VGGNet/nexar2/{}_score".format(job_name)
# Directory which stores the snapshot of trained models.
snapshot_dir = "models/VGGNet/nexar2/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/nexar2/{}_score".format(job_name)
# Directory which stores the detection results.
output_result_dir = "{}/datasets/nexar/results/{}_score".format(os.environ['HOME'], job_name)
