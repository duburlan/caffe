...
model_name = "ResNet_nexar2_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/ResNet/nexar2/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/ResNet/nexar2/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/ResNet/nexar/{}".format(job_name)
# Directory which stores the detection results.
output_result_dir = "{}/datasets/nexar/results/{}".format(os.environ['HOME'], job_name)
